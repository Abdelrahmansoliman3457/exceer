            ...
            <div class="main-select-date">
              ...
              <div class="select-time">
                ...
                <div class="panel-body form-group">  
                    ...
                    <label class="switch">
                        <input type="checkbox" v-model="workTimes.Sunday.is_holiday">
                        <div class="slider round"></div>
                    </label>
                    <p class="font-3">{{ $t('Glopal.vacation') }}</p>
                </div>
...
export default {
  ...
  methods: {
    ...
    //   setTimeout(() => {
    //     this.time_saved = false
    //   }, 1500);
    //  console.log(this.workTimes.Saturday.from, "from")
    //  console.log(this.workTimes.Saturday.to, "to")
    // },
